...
public class ChargeGUI extends JFrame {
	...
	private void extracted() {
		...
		springLayout.putConstraint(SpringLayout.WEST, textField, 204, SpringLayout.WEST, getContentPane());
		springLayout.putConstraint(SpringLayout.EAST, textField, -164, SpringLayout.EAST, getContentPane());
		springLayout.putConstraint(SpringLayout.EAST, lbl, -16, SpringLayout.WEST, textField);
		getContentPane().add(textField);
		textField.setColumns(10);

		btn = new JButton("");
		springLayout.putConstraint(SpringLayout.WEST, btn, 19, SpringLayout.EAST, textField);
		springLayout.putConstraint(SpringLayout.SOUTH, btn, 0, SpringLayout.SOUTH, lbl);
		springLayout.putConstraint(SpringLayout.EAST, btn, -40, SpringLayout.EAST, getContentPane());
		...
		springLayout.putConstraint(SpringLayout.SOUTH, lbl, -53, SpringLayout.NORTH, btnReset);
		springLayout.putConstraint(SpringLayout.SOUTH, btnReset, -8, SpringLayout.SOUTH, getContentPane());
		springLayout.putConstraint(SpringLayout.EAST, btnReset, -143, SpringLayout.EAST, getContentPane());
		...
		springLayout.putConstraint(SpringLayout.SOUTH, textField, -10, SpringLayout.NORTH, lblNewLabel);
		springLayout.putConstraint(SpringLayout.NORTH, lblNewLabel, 8, SpringLayout.SOUTH, btn);
		springLayout.putConstraint(SpringLayout.WEST, lblNewLabel, 203, SpringLayout.WEST, getContentPane());
		springLayout.putConstraint(SpringLayout.SOUTH, lblNewLabel, -23, SpringLayout.NORTH, btnReset);
		springLayout.putConstraint(SpringLayout.EAST, lblNewLabel, -69, SpringLayout.EAST, getContentPane());
		Font newFont2 = new Font("맑은 고딕", Font.BOLD, 16);
		lblNewLabel.setFont(newFont2);
		getContentPane().add(lblNewLabel);

		Panel panel = new Panel();
		springLayout.putConstraint(SpringLayout.NORTH, textField, 28, SpringLayout.SOUTH, panel);
		springLayout.putConstraint(SpringLayout.SOUTH, panel, -151, SpringLayout.SOUTH, getContentPane());
		...
		lblNewLabel_1.setBounds(0, 20, 428, 273);

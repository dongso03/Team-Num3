...
public class PurchaseGUI extends JFrame {
	...
	public PurchaseGUI(FirstPage firstpage, ChargeGUI chargeGUI, int nowPrice) {
		...
		sl_panel.putConstraint(SpringLayout.EAST, comboBox, -204, SpringLayout.EAST, panel);
		comboBox.setBackground(new Color(250, 250, 210));
		panel.add(comboBox);

		JButton checkBtn = new JButton("");
		sl_panel.putConstraint(SpringLayout.NORTH, checkBtn, 0, SpringLayout.NORTH, panel);
		sl_panel.putConstraint(SpringLayout.WEST, checkBtn, 61, SpringLayout.EAST, comboBox);
		sl_panel.putConstraint(SpringLayout.EAST, checkBtn, -33, SpringLayout.EAST, panel);
		...
		panel_8.setBounds(10, 330, 353, 81);
		...
		btnReset.setBounds(67, 10, 101, 33);
	...
	/*	btnAuto = new JToggleButton("");
		...
		panel_1.setBounds(12, 79, 345, 248);
		getContentPane().add(panel_1);

		JPanel panel_9 = new JPanel();
		panel_9.setBackground(new Color(250, 250, 210));
		panel_9.setBounds(451, 360, 620, 108);
		...
		lblNewLabel_3.setBounds(0, 10, 73, 22);
		...
		lblNewLabel_11.setBounds(0, 76, 73, 22);
		...
		btnNewButton_2.setBounds(435, 63, 123, 35);
		...
		priceLbl.setBounds(85, 82, 221, 15);
